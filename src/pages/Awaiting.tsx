...
const Awaiting = () => {
  ...
  const EmptyState = () => (
    <div className="text-center py-16">
      ...
      <h3 className="text-xl font-semibold text-white mb-2">No pending responses</h3>
      <p className="text-white/70 max-w-md mx-auto">You're all up to date with your responses! New requests will appear here.</p>
    </div>
  );
    ...
    return (
      <div className="min-h-screen flex items-center justify-center bg-gradient-to-br from-purple-600 via-violet-600 to-purple-800">
        <div className="text-center">
          ...
          <p className="mt-4 text-white/70">Loading awaiting responses...</p>
        </div>
      </div>
    );
  }
    ...
    <div className="min-h-screen bg-gradient-to-br from-purple-600 via-violet-600 to-purple-800">
      ...
      <div className="max-w-7xl mx-auto px-6 py-8">
        <div className="mb-8">
          ...
          <p className="text-white/70">People waiting for your response</p>
        </div>
