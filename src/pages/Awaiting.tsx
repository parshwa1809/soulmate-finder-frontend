...
const Awaiting = () => {
  ...
  const EmptyState = () => (
    <div className="text-center py-16">
      ...
      <h3 className="text-xl font-semibold text-foreground mb-2">No pending responses</h3>
      <p className="text-muted-foreground max-w-md mx-auto">You're all up to date with your responses! New requests will appear here.</p>
    </div>
  );
    ...
    return (
      <div className="min-h-screen flex items-center justify-center bg-background">
        <div className="text-center">
          ...
          <p className="mt-4 text-muted-foreground">Loading awaiting responses...</p>
        </div>
      </div>
    );
  }
    ...
    <div className="min-h-screen bg-background">
      ...
      <div className="border-b border-border bg-card/50 backdrop-blur-sm sticky top-0 z-50">
        <div className="max-w-7xl mx-auto px-6 py-4 flex items-center justify-between">
          ...
          <h1 className="text-xl font-semibold text-foreground">Awaiting Response</h1>
      ...
      <div className="max-w-7xl mx-auto px-6 py-8">
        <div className="mb-8">
          <div className="flex items-center gap-3 mb-2">
            ...
            <h2 className="text-2xl font-bold text-foreground">Awaiting Response</h2>
          </div>
          <p className="text-muted-foreground">People waiting for your response</p>
        </div>
